...
var easySwitchable = {
    ...
    switchHandle : function( o, target ){
        var effects = o.effects,
            isReverse = false,
            index = typeof target === 'number' ? target : $( target ).attr( 'data-index' ),
    ...
    initIndex : function( o ){
        ...
        indexElem = $( '<div class="sc_index">' + html + '</div>' )
            .appendTo( o.target )
            .find( 'a' ); 
    ...
    initNav : function( o ){
        ...
        if( o.nav ){
            navElem = $( '<a href="#" class="sc_prev" style="display:none"></a>' +
            ...
            // 自定义的翻页切换按钮绑定切换效果
            navElem = $( 'a.sc_prev,a.sc_next', target );
        }        
    ...
    autoRun : function( o ){
        o.timer = setInterval(function(){
            easySwitchable.patterns[ o.effects ]( o, undefined, false );
        }, o.interval );           
    },
...
$.each({
    ...
    easySwitchable.patterns[ name ] = function( o, nextIndex, isReverse ){
        ...
        // 开始切换动画
        listElem.animate( animMap, o.duration, o.easing, complete );      
...
Switchable.prototype = {
    ...
    destroy : function(){
        ...
        target.off( 'mouseenter.switchable mouseleave.switchable mouseleave.switchableauto likechange' );
        ...
        if( o.imglazyload ){
            o.itemElem.slice( 2 ).off( 'loadimg' );
        }
    ...
    pause : function(){
        ...
        if( o ){
            ...
            if( o.auto ){
                o.target.off( 'mouseleave.switchableauto' );
            }
        }
    },
