...
var easyTooltip = {
    ...
    createTip : (function(){
        ...
        return function( reCreate ){                
            ...
            tipElem = tipElem && !reCreate ? tipElem :
                $( '<div class="eui_tooltip" style="z-index:' + ( zIndex++ ) + '">' +
    ...
    initStyle : function( o ){
        ...
        if( (trigger !== 'mouseenter' && trigger !== 'focus') || o.unClose ){
            ...
            btnClose.css( 'display', 'none' ).off( 'click.tooltip' );
        }
    ...
    close : function( o ){
        ...
        if( o.currentTarget ){
            o.currentTarget.trigger( 'likeclose' );
...
$.each([ 'show', 'hide' ], function( i, item ){
