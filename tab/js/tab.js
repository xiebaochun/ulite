...
easyTab.patterns = {
    ...
    normal : function( o, nextMenu ){
        ...
        nextMenu.addClass( 'current' ).trigger( 'likeinit' );
...
$.each({
    ...
    easyTab.patterns[ name ] = function( o, nextMenu ){
        ...
        contentElem.animate( animMap, o.duration, o.easing, complete );
    };
});
...
Tab.prototype = {
    ...
    destroy : function(){
        ...
        if( o.auto ){
            easyTab.clear( o ); 
            o.target.off( 'mouseenter.tab mouseleave.tab' );
        }
        
        o.target.off( 'likechange' );
        o.menuElem.off( 'click.tab mouseenter.tab mouseleave.tab' );                
